...
const LEVEL1_WAVES = [
  ...
  [{type:'slime',count:5},{type:'runner',count:6},{type:'ghost',count:4}],
  [{type:'tank',count:6},{type:'runner',count:6},{type:'fire',count:6}],
];

// 第二关：波次 0-6（共7波）
const LEVEL2_WAVES = [
  [{type:'slime',count:12},{type:'runner',count:8},{type:'tank',count:4}],
  [{type:'tank',count:4},{type:'runner',count:6},{type:'ghost',count:4}],
  [{type:'runner',count:12},{type:'tank',count:6},{type:'fire',count:4}],
